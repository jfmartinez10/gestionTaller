...
public void mostrarMenuEmpleado() {
    ...
    do {
        ...
        System.out.println("4. Eliminar Vehículos de Cliente ");
        System.out.println("5. Mostrar Órdenes de Trabajo");
        System.out.println("6. Eliminar Órdenes de Trabajo");
        ...
        switch (opcion) {
            ...
            case 3 -> {} //mostrarVehiculoCliente()        
            case 4 -> {} //eliminarVehiculoCliente()
            case 5 -> {} //mostrarOrdenesTrabajo()
            case 6 -> {} //eliminarOrdenesTrabajo()
